...
class HTTPRequestUtil
{
    ...
    public function postJson($url, $body = [], array $headers = [])
    {
        $options = [
    ...
    public function patch($url, $formData = [], array $headers = [])
    {
        $options = [
            RequestOptions::FORM_PARAMS    => $formData,
        ];
        ...
        return $this->rawPatch($url, $options);
    }
    ...
    public function rawPatch($url, $options = [])
    {
